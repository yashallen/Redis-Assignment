...
module.exports = {
  ...
  actions: (data) => {
    ...
    const actions = [{
      type: 'add',
      path: `../../app/${device}/components/{{properCase name}}/index.js`,
      templateFile: componentTemplate,
      abortOnFail: true,
    }, {
      type: 'add',
      path: `../../app/${device}/components/{{properCase name}}/tests/index.test.js`,
    ...
    if (data.wantMessages) {
      actions.push({
        type: 'add',
        path: `../../app/${device}components/{{properCase name}}/messages.js`,
